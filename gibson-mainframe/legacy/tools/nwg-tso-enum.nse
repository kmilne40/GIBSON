...
Driver = {
  ...
  -- pass is actually the user id we want to try
	...
	-- Added more conditions which would allow for success
    if not self.tn3270:find("ENTER USERID")
       ...
       and not self.tn3270:find("IKJ56420I")
       and not self.tn3270:find("IKJ56425I")
       and not self.tn3270:find("IKJ56714A") then
